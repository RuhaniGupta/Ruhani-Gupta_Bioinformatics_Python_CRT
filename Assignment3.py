'''Write a python program to a book class declare states as
-->Book name
-->Auther name
-->publisher name
-->published date
...
class Book():
    ...
    def get_details(self):
        ...
        print(f"Name of the author is:{self.AuthorName}")  
...
book2=Book('python programming','Ruhi')
book3=Book('')
book4=Book('oop','jam',123,345)
book5=Book('ads','hide',123,456,"team")
book1.get_details()
book2.get_details()
book3.get_details() 
book4.get_details()
