...
Problem:
You are given an array of integers representing student scores.Your task is to sort the array in ascending
order using a basic sorting algorithm (Bubble Sort / Selection Sort / Insertion Sort).
